...
return(
	<View style={{flex:1,alignSelf:'center',justifyContent:'center',alignItems:'center'}}>
		<Text style={{fontWeight:'bold',fontSize:20,alignSelf:'center'}}>No folder</Text>
		<TouchableOpacity style={{marginTop:20,alignSelf:'center',borderRadius:10,justifyContent:'center',alignItems:'center',width:width*0.5,alignSelf:'center',height:40,backgroundColor:Colors.primaryColor}}><Text style={{color:'white',fontWeight:'bold',fontSize:20}}>Create Folder</Text></TouchableOpacity>
	</View>
)
}
        ...
        return (
			...
			<View style={styles.followers}>
				<View style={{width:'30%',alignItems:'center',}}>
					<Text style={{fontWeight:'bold',fontSize:20,color:Colors.primaryColor}}>0</Text>
					<Text>Following</Text>
				</View>
				<View style={{width:'30%',alignItems:'center',}}>
					<Text style={{fontWeight:'bold',fontSize:20,color:Colors.primaryColor}}>0</Text>
				...
				<View style={{width:'30%',alignItems:'center',}}>
					<Text style={{fontWeight:'bold',fontSize:20,color:Colors.primaryColor}}>0</Text>
					<Text>Drafted events</Text>
				</View>
			</View>

			<View style={{width,backgroundColor:'red',height:height*0.6,marginTop:40,}}>
    <Tab.Navigator screenOptions={({routeName})=>{}}>
      <Tab.Screen name="Image" component={ImageScreen} options={{
    tabBarIcon: () => <Entypo name="images" size={24} color="black" />,tabBarShowLabel:false }} />
      <Tab.Screen name="people" component={PeopleScreen}  options={{
    tabBarIcon: () => <AntDesign name="clouddownloado" size={24} color="black" />,tabBarShowLabel:false }} / >
